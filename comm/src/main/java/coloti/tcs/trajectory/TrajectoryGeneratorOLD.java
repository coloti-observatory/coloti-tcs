...
public class TrajectoryGeneratorOLD implements ITrajectoryGenerator {
    ...
    public TrajectoryGeneratorOLD() {
    }

    public TrajectoryGeneratorOLD(final Target source, final Iers iers, final Observer obs) {
    ...
    public TrajectoryGeneratorOLD(final Iers iers, final Observer obs) {
        trajectoryNodes = new LinkedList<>();
        this.iers = iers;
        this.observer = obs;
