...
public class backup_tcs2 {
    ...
    public backup_tcs2(){//boolean connectX, boolean connectY, boolean connectDome, String IDserX, String IDserY, String IDserDome)
        Configure();
    ...
    */
    ...
    public static void main(final String[] a){ // sudo chmod 777 /dev/ttyS0     sudo chmod 777 /dev/ttyUSB0
        ...
        // inizializzazione
        backup_tcs2 tcs = new backup_tcs2();
