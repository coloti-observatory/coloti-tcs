...
import opcua.newexample.ServerNamespace;
...
public class UaServer {
    ...
    private final ServerNamespace exampleNamespace;
    ...
    public UaServer() throws Exception {

        buildConfig("Test server", "TestServer");
        server = new OpcUaServer(serverConfig);
        
        exampleNamespace = new ServerNamespace(server);
        exampleNamespace.startup();

    }

    private void buildConfig(String serverName, String appName) throws Exception {
